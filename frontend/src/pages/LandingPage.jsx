        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {topEngineers.map((engineer, index) => (
            <motion.div
              ...
              transition={{ delay: index * 0.1 }}
              whileHover={{ y: -8 }}
              className="bg-white rounded-2xl p-6 shadow-lg card-elevation"
            >
              ...
              <div className="text-center">
                <h3 className="text-xl font-semibold text-dark mb-1">{engineer.name}</h3>
                <p className="text-gray-600 text-sm mb-3">{engineer.specialization}</p>
                <div className="flex items-center justify-center gap-1 mb-4">
                  <FiStar className="text-yellow-400 fill-current" />
                  <span className="font-semibold">{engineer.rating}</span>
                  <span className="text-gray-500 text-sm">({engineer.reviews} reviews)</span>
                </div>
                <p className="text-sm text-gray-500 mb-4">{engineer.projects} projects completed</p>
